        ...
        <table class="table-auto border border-blue-500 mt-4">
            <thead>
                <tr class="border border-black border-2">
                    ...
                    <th class="px-4 py-2 border border-black border-2" style="width: 160px;">Username</th>
                    <th class="px-4 py-2 border border-black border-2" style="width: 160px;">Email</th>
                    <th class="px-4 py-2 border border-black border-2" style="width: 160px;">Password</th>
                    <th class="px-4 py-2 border border-black border-2" style="width: 80px;">Role</th>
                    <th class="px-4 py-2 border border-black border-2" style="width: 80px;">Status</th>
                </tr>
            </thead>
            <tbody>
                <?php
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['uid'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['ufname'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['ulname'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['username'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['email'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['password'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['role'] . '</td>
                            <td class="border px-4 py-2 border border-black border-2">' . $row['status'] . '</td>
                        </tr>';
                    }
                }
                ?>
